#!/usr/bin/env python3
"""
Generate BiT Non-IID experiment configuration files
Non-IID environment: data_split=non_iid, alpha=0.1 (strong heterogeneity)
"""
...
def generate_experiment_configs():
    """Generate all Non-IID experiment configurations"""
...
def save_experiments(experiments):
    ...
    print("=" * 80)
    print("Generating BiT Non-IID Experiment Configurations")
    print("=" * 80)
    print(f"Non-IID parameter: α = 0.1 (strong heterogeneity)")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    print("\n🎉 Non-IID experiment configurations generated successfully!")
